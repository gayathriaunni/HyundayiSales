...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM sales_officers WHERE user_id = '$user_id' AND password = '$password'";
    ...
    if ($result->num_rows > 0) {
        ...
        header("location: salesofficerassign.php");
        exit(); 
...
<body>
    ...
    <form method="POST" action="salesofficerassign.php">
        <h3>Login Here</h3>
